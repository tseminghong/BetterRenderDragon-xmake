...
private:
  ...
  Microsoft::WRL::ComPtr<ABI::Windows::Graphics::Display::IDisplayInformation>
      displayInfo;

  EventRegistrationToken pointerMovedToken, pointerExitedToken,
      pointerPressedToken, pointerReleasedToken, pointerWheelChangedToken;
  ...
  HRESULT onPointerExited(ABI::Windows::UI::Core::ICoreWindow *sender,
                          ABI::Windows::UI::Core::IPointerEventArgs *args);
  ...
  HRESULT onPointerReleased(ABI::Windows::UI::Core::ICoreWindow *sender,
                            ABI::Windows::UI::Core::IPointerEventArgs *args);
  HRESULT
  onPointerWheelChanged(ABI::Windows::UI::Core::ICoreWindow *sender,
                        ABI::Windows::UI::Core::IPointerEventArgs *args);
  ...
  HRESULT
  onDpiChanged(ABI::Windows::Graphics::Display::IDisplayInformation *sender,
               IInspectable *args);
};
